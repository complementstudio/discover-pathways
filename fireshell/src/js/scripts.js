...
/* globals Dragdealer, skrollr */
  ...
  function updateCookie(){
    ...
    $(':checkbox').each(function(){
      checklistValues[this.id] = this.checked;
    });

    $.cookie('yeshivaChecklist', checklistValues, { expires: 7, path: '/' });
  }

  function repopulateFormELements(){
    var checklistValues = $.cookie('yeshivaChecklist');
    if(checklistValues){
      Object.keys(checklistValues).forEach(function(element) {
        var checked = checklistValues[element];
